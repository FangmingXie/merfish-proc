...
cword_config = 'merfish_config_zebrafinch_18bits_FX'
### end of input
...
for posname in posnames:
    logging.info(f'-------{posname}--------')
    # posname = posnames[0] #'6-Pos004_003' # 
    ...
    for i, (readout,hybe,channel) in enumerate(bitmap):
        try:
            ...
            print("failed: ", readout, hybe, channel)
            continue
